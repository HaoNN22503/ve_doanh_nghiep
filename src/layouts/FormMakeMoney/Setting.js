...
function showBilling() {
  ...
  return (
    ...
    <div className="setting-all">
        ...
        <div onClick={showAccount} style={
            accountDisplay ? {backgroundColor:"black",color:"white"} 
            : {}
        }
        className="setting-service">
            <div className="setting-service-icon"><AiOutlineSetting/></div>
            <div className="setting-service-info">
                <div className="setting-service-info-1">Tài khoản</div>
                <div className="setting-service-info-2">Thông tin tài khoản kiếm tiền</div>
            </div>  
        </div>
        <div onClick={showNoti} style={
            notiDisplay ? {backgroundColor:"black",color:"white"} 
            : {}
        } className="setting-service">
            <div className="setting-service-icon"><BiBell/></div>
            <div className="setting-service-info">
                <div className="setting-service-info-1">Thông báo</div>
                <div className="setting-service-info-2">Thông báo công việc & lượt tương tác với khách hàng</div>
            </div>
        </div>
        <div onClick={showSecurity} style={
            securityDisplay ? {backgroundColor:"black",color:"white"} 
            : {}
        } className="setting-service">
            <div className="setting-service-icon"><HiOutlineKey/></div>
                <div className="setting-service-info">
                    <div className="setting-service-info-1">Bảo mật</div>
                    <div className="setting-service-info-2">Bảo mật thông tin công việc của bạn</div>
                </div>
        </div>
        <div onClick={showBilling} style={
            billingDisplay ? {backgroundColor:"black",color:"white"} 
            : {}
        } className="setting-service">
            <div className="setting-service-icon"><RiBillLine/></div>
            <div className="setting-service-info">
                <div className="setting-service-info-1">Tất toán</div>
                <div className="setting-service-info-2">Nghiệm thu & thu hồi thành quả</div>
            </div>
        </div>
     </div>
